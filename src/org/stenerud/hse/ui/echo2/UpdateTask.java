...
/**
 * Works with Echo2Application to schedule recurring server push events. <br>
 * Upon calling start(), the task will hook into the application's server polling mechanism, and will notify all
 * listeners each time it is updated.
 * 
...
public class UpdateTask
{
	...
	/**
	 * Constructor. <br>
	 * Note: The interval should be set to a minimum of 500 ms to ensure smooth operation.
	 * 
	...
	/**
	 * Update this task. <br>
	 * This is called from within Echo2Application and should not be called by the user.
	 * 
	 * @see Echo2Application Echo2Application
	 */
	public void update()
	...
	/**
	 * Start this task. <br>
	 * When started, this task's update will be called repeatedly after the interval period.
	 */
	public void start()
	{
		nextUpdate = new Date().getTime() + interval;
		Echo2Application.getCurrent().addTask(this);
	}
	...
	public void stop()
	{
		Echo2Application.getCurrent().removeTask(this);
	}
