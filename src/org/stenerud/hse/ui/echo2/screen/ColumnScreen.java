...
/**
 * This Screen implementation is similar CustomPane, but does not subclass from a Pane. <br>
 * This class is needed because adding a pane to a tabbedpane only works if the tabbedpane is set to a definite size
 * (PERCENT won't work).
 * 
...
public abstract class ColumnScreen extends Column implements Screen
{
	...
	private static class ValidationExceptionListener implements ActionListener
	{
		...
		{
			ApplicationHelper.setFocus(ex.getComponent());
		}
	}
