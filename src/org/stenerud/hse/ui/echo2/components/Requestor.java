...
import org.stenerud.hse.ui.echo2.CustomWindowPane;
...
public abstract class Requestor extends CustomWindowPane
{
	 ...
	 * This method gets called by the internal action listener, and allows the implementation to add extra processing
	 * in response to an action. <br>
	 * If true is returned, the requestor is closed, and all registered event listeners are notified. <br>
	 * If false is returned, the requestor remains open, and the registered event listeners are NOT notified.
	 * 
	 * @param ev the event
