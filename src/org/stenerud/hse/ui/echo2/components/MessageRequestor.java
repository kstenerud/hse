...
import org.stenerud.hse.ui.echo2.validation.ComponentValidationException;
 ...
 */
public abstract class MessageRequestor extends Requestor
{
	 ...
	 */
	public MessageRequestor(String title, String message, Extent width, Extent height)
	{
	 ...
	 * 
	 * @param contents the component containing the main contents. This will have the main message lable in it already.
	 */
