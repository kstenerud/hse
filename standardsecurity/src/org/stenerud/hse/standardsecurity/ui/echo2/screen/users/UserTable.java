...
import org.stenerud.hse.base.ui.echo2.RowListener;
import org.stenerud.hse.base.ui.echo2.Theme;
import org.stenerud.hse.base.ui.echo2.component.BasicEditorTable;
 ...
 */
public class UserTable extends BasicEditorTable
{
	...
	private TableCellRenderer tableCellRenderer = new TableCellRenderer()
	{
		...
		public Component getTableCellRendererComponent(Table table, Object value, int column, int row)
		{
			...
			if ( columnType == ColumnInformation.COLUMN_TYPE_COMMAND )
			{
				...
				if ( model.canUpdate(row) )
				{
					button = new PushButton(Theme.getIcon16(Icons.EDIT));
				...
				{
					button = new PushButton(Theme.getIcon16(Icons.DELETE));
