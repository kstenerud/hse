package org.stenerud.hse.standardsecurity.business.user;
...
public class UserBusiness
{
	...
	public boolean canUpdate(User user)
	{
		return hasWritePermission(user)
				&& (!user.isAdministrator() || (currentUser.get().isAdministrator() && properties.getBoolean(
	...
	/**
	 * Get all groups. <br>
	 * This is only called in order to set a group outside of the current user's
	 * group, so we check for WRITE ALL.
	 * 
