...
/**
 * A facade that overrides tab rendering, replacing the normal component with a
 * background-imaged button.
 * 
...
public class BasicImageTabModel implements TabModel
{
	...
	{
		/*
		 * Setting the background color of one tab seems to affect the entire tab
		 * panel, so use images instead.
		 */
