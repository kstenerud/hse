...
public class ColumnFormatter
{
	 ...
	 * @return the style name.
	 */
	public String getStyle(int type, String styleSuffix)
	{
		String realSuffix = null == styleSuffix ? "" : "." + styleSuffix;
		if ( isNumeric(type) )
		{
			return "EditTable.Basic.Number" + realSuffix;
		}

		return "EditTable.Basic.String" + realSuffix;
	}
