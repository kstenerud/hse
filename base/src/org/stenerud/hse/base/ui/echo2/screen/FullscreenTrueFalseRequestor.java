 ...
 */
public class FullscreenTrueFalseRequestor extends FullscreenMessageRequestor
{
	 ...
	 */
	public FullscreenTrueFalseRequestor(String title, String message, String trueString, String falseString)
	{
		super(title, message);
	 ...
	 * Default Constructor.
	 */
	public FullscreenTrueFalseRequestor()
	{
		super();
	}
