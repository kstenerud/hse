package org.stenerud.hse.example.ui.echo2;
...
/**
 * An example HSE user interface. <br>
 ...
 */
public class ExampleUserInterface extends Echo2UserInterface implements UserChangeAware
{
	...
	public class ScreenActivator implements ActionListener
	{
		private static final long serialVersionUID = 1L;
	 ...
	 * into a series of menus and submenus. <br>
	 * It also adds a logout item at the top level menu.
	 */
	private void buildMainMenu()
	{
		...
		// Logout menu item on the top-level menu.
		mainMenu.addItem(null, "Menu.Level1", messages.get("screen.logout"), new ActionListener()
		{
			private static final long serialVersionUID = 1L;
